  ...
  return (
    <div className="sm:hidden hidden md:block flex lg:hidden justify-center items-center">
      <div className="w-[90%] pt-[110px] pb-[70px] md:p-24 md:pt-[140px]">
        ...
        <div className="pt-7 flex gap-4">
          {slides.map((slide, index) => (
            <button
              ...
              className={`w-[20%] p-1.5 text-[18px] border ${
        ...
        {/* Slider Section */}
        <div className="overflow-hidden  md:w-[90%] md:h-[90%] w-[90%] relative mt-10">
          <div
          ...
          >
            {slides.map((slide) => (
              <div
                key={slide.id}
                className={`rounded-[80px] lg:p-[60px] md:p-[60px] flex flex-col gap-[1rem] md:w-[500px] md:h-[400px]  w-[340px] h-[360px]  p-10 border`}
...
export default TabContentSwipper;
