          ...
          <div className="w-[75%]">
            <div className="pt-[2rem] border-b border-gray-400 py-2">
              <div
                ...
                className="py-2 flex lg:gap-[37.5%] md:gap-[10%] text-[20px] lg:text-[24px] sm:text-[24px] md:text-[24px] font-medium"
              >
            ...
            <div className="pt-[2rem] border-b border-gray-400 py-2">
              <div
                ...
                className="py-2 flex lg:gap-[47%] md:gap-[10%] text-[20px] lg:text-[24px] sm:text-[24px] md:text-[24px] font-medium"
              >
                <h2 className="cursor-pointer">
            ...
            <div className=" pt-[2rem] py-2">
              <div
                ...
                className="py-5 flex lg:gap-[39%] md:gap-[15%] text-[20px] lg:text-[24px] sm:text-[24px] md:text-[24px] font-medium"
              >
                <h2 className="cursor-pointer">
